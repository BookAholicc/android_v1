...
public class APIUtils {
   ...
   /*Home API - NEW ARRIVALS*/
    ...
    /* HOME _ POPULAR*/
    public static final String HOME_ENDPOINT_GENRE = "https://us-central1-bookaholicc-786.cloudfunctions.net/genreViewer";
    ...
    /*PLACE ORDER*/
    public static final String HOME_ENDPOINT_PLACE_ORDER = "";


    /*NOTIFICATION*/
    public static final String HOME_ENDPOINT_GET_NOTIFICATION = "";


    /*VIEW PRODUCT*/
    public static final String HOME_ENDPOINT_VIEW_PRODUCT = "";
    ...
    public static final String RD = "readingDuration";
