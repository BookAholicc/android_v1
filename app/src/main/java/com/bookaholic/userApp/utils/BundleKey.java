...
public class BundleKey {
    ...
    public static final String ARG_EXAM_BASE = "EXAM_BASE";
    ...
    public static final String PR7 = "p7";
    public static final String PR15 = "p7";
    public static final String PR30= "p7";


    public static String[] RETUNR_STRINGS = {"2 Days","4 Days" , "6 Days"};
    public static String ARG_FULL_NAME = "FIRST_NAME" ;
    public static String NAME = "name";
    public static String AUTHOR = "ait";
}
