 ...
 * copied from https://stackoverflow.com/questions/18889131/gallery-like-view-with-center-image-zoom
 */
public class HorizontalZoomViewer extends HorizontalScrollView implements View.OnTouchListener {
    ...
    public HorizontalZoomViewer(Context context, AttributeSet attrs) {
        super(context, attrs);
